...
export const AdminDasboardChart = ({
  num,
  total,
}: AdminDasboardChartProps) => {
      ...
      <div className="relative">
        ...
        <div className="grid grid-cols-3 gap-4 mt-2">
          ...
          <div className="rounded-xl bg-[#1c2518] p-3 text-center">
            ...
            <p className="text-xl font-bold text-[#4d8fe1]">
              {num}
            </p>
          ...
          <div className="rounded-xl bg-[#1c2518] p-3 text-center">
            ...
            <p className="text-xl font-bold text-[#40d075]">
              {total}
            </p>
          ...
          <div className="rounded-xl bg-[#1c2518] p-3 text-center">
            ...
            <p className="text-xl font-bold text-[#a8d96c]">
              {percentage}%
            </p>
